...
public class WithdrawService {
	...
	public BankAccount getWithdraw(UserPrincipal currentUser, long id, 
			double amount) {
		...
		doWithdraw(targetAccount,amount,account);
		return targetAccount;
	}
	
	public void doWithdraw(BankAccount targetAccount,
